...
/**
 * @deprecated The functionality is to be moved to {@link ActiveUserService}. Then include that
 *     class in other services instead of extending this one. Composition over inheritance.
 */
@Deprecated
