...
public class VoteController {
  ...
  public VoteController(final VoteService voteService, final ActiveUserService activeUserService) {
  ...
  public ModelAndView handleVote(@ModelAttribute final VoteRequest voteRequest) {
    final String requestMethod = voteRequest.getMethod().toUpperCase();
