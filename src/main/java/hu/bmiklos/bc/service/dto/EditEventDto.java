...
public class EditEventDto {
  ...
  @Nullable private final Integer hostExternalId;
  @Nullable private final UUID hostId;
  ...
  private EditEventDto(
      UUID id, UUID bookId, Instant time, @Nullable Integer hostExternalId, @Nullable UUID hostId) {
    this.id = id;
    this.bookId = bookId;
    this.time = time;
