...
class SuggestionControllerTest {
  ...
  private DeprecatedSuggestionController controller;
  ...
  void setup() {
    ...
    controller = new DeprecatedSuggestionController(activeUserService, suggestionService);
  }
  ...
  void getSuggestionEditsOwnSuggestions() {
    ...
    var book =
        new BookAndSuggesterDto(
            new BookDto(UUID.randomUUID(), "Author", "Title", "url://"), Set.of(suggestion));
    ...
    assertEquals(
        "suggestion/edit",
        result.getViewName(),
        "The users should be able to edit their own suggestions.");
  }
