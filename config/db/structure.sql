...
ALTER TABLE ONLY public.participants
    ADD CONSTRAINT pk_participants PRIMARY KEY (event_id, participant_external_id);
...
--
-- Name: user_password user_passwords_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--
...
ALTER TABLE ONLY public.events
    ADD CONSTRAINT fk_events_books FOREIGN KEY (book_id) REFERENCES public.books(id);
...
ALTER TABLE ONLY public.suggestions
    ADD CONSTRAINT fk_suggestions_book_id FOREIGN KEY (book_id) REFERENCES public.books(id);
...
ALTER TABLE ONLY public.suggestions
    ADD CONSTRAINT fk_suggestions_user_id FOREIGN KEY (user_id) REFERENCES public.users(id);
